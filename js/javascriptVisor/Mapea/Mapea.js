...
(function() {
    ...
    var allScriptTags = [];
    allScriptTags.push("<script src=\"" + hostMapea + "Configuration.js\"></script>");
    allScriptTags.push("<script src=\"" + hostOL + "OpenLayers.js\"></script>");
    allScriptTags.push("<script src=\"" + hostOL + "lib/deprecated.js\"></script>");

    var isMobile = ((/(android|bb\d+|meego|ip(hone|od|ad)|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)|pocket|psp|series(4|6)0|symbian|treo|windows (ce|phone)|xda|xiino)/i.test(navigator.userAgent||navigator.vendor||window.opera))
