...
Mapea.Layer.Geosearch = OpenLayers.Class(Mapea.Layer.Vector, {
    ...
    */
    ...
    setMap : function(map) {
        ...
        // unregister and register events
        this.events.unregister("featureselected", this, this._showPopupFeature);
        this.events.register('featureselected', this, this._showPopupFeature);
        this.events.unregister("featureunselected", this, this._showPopupFeature);
