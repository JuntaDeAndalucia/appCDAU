...
Mapea.SigcMapea = OpenLayers.Class({
    ...
    contexto: Mapea.Configuration.contexts,

    url: Mapea.Configuration.contextsUrl,

    title: Mapea.Configuration.contextsTitle,

    /**
    * Variables for search funcionality
    */
    swCallejero: Mapea.Configuration.callejeroWSUrl,
    
    geosearchUrl: Mapea.Configuration.geosearchUrl,

    strDefinedThemes: Mapea.Configuration.themes,

    strDefinedThemesUrl: Mapea.Configuration.themesUrl,
    
    geosearchbylocationUrl : Mapea.Configuration.geosearchByLocation,
    
    geosearchDistance : Mapea.Configuration.geosearchByLocationDistance,
    ...
    */
     ...
     */
    sgcmOptionsDefault: {
        projectionDefault: Mapea.Configuration.SRS,
        wmcfileDefault: ['callejerocacheado'],
        layersDefault: null,
        controlsDefault: ['panzoom'],
        centerDefault: '0,0',
        drawPinDefault: false,
        zoomDefault: '0',
        labelDefault: null,
        bboxDefault: '0,0,0,0',
     ...
     *                       this map. Default is defined into Mapea.Configuration.SRS.
    ...
    initialize: function(param) {
        ...
        if (typeof(param) == 'string') {
            ...
            this.sgcmOptions.drawPin = this.sgcmOptionsDefault.drawPinDefault;
            ...
            this.sgcmOptions.printer = this.sgcmOptionsDefault.printerDefault;
        ...
        // PRINTER =========================================================================
            if(param.printer){
                if (typeof param.printer != 'string') {
                    Mapea.Util.showErrorMessage('SigcMapea.constructor: El parámetro printer debe ser un String y se ha introducido un parámetro tipo: '+ typeof param.printer);
                }
                else {
                    this.sgcmOptions.printer = param.printer;
                }
            }
            else {
                this.sgcmOptions.printer = this.sgcmOptionsDefault.printerDefault;
        ...
        if (!this.error) {
            if (this.sgcmOptions.center && (this.sgcmOptions.center != this.sgcmOptionsDefault.centerDefault))
            {
                ...
                if (coordsPin.length == 2)
                {
                    ...
                    this.sgcmOptions.drawPin = (OpenLayers.String.trim(coordsPin[1].toLowerCase()) == "true");
                }
                ...
                if (latLon.length == 2){
                    ...
                    this.map.drawCenter(this.strLon, this.strLat, centerZoom, centerLabel, this.sgcmOptions.drawPin);                    
                }
                else
                {
                    Mapea.Util.showErrorMessage('El formato del parámetro <b><i>center</i></b> es erróneo');
...
/**-----------------------------------------------------------------------------------------------------------*/
    ...
    addLabel: function(text){
        ...
        this.map.drawCenter(this.strLon, this.strLat, centerZoom, this.sgcmOptions.label, this.sgcmOptions.drawPin);
    },
    ...
    setCenter: function(x, y, zoom, drawPin) {
        ...
        this.sgcmOptions.drawPin = drawPin;
        ...
        if (latLon.length == 2) {
            ...
            var centerZoom = (this.sgcmOptions.zoom && (this.sgcmOptions.zoom != this.sgcmOptionsDefault.zoomDefault))? this.sgcmOptions.zoom : null;
            this.map.drawCenter(this.strLon, this.strLat, centerZoom, null, drawPin);
        }
    },
    ...
    addPrinter: function(printServiceURL, layoutParams, pagesParams, options) {
        if (!printServiceURL) {
            // default value
            printServiceURL = Mapea.Configuration.printerUrl;
            ...
            pagesParams = pagesParams || {
               ...
               infoSRS : "\n" + Mapea.Util.getSRSDescription(this.map.projection),
        ...
        var printerCtrl = new Mapea.Control.Printer(printServiceURL,
                layoutParams, pagesParams, options);
