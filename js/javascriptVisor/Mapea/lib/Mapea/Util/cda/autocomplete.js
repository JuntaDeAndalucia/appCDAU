...
Autocomplete = (function(){
		...
		_waitSourceAutocomplete = function(request, response) {
			if ((window.callejeroProxy != null) && (window.callejeroProxy.client != null)
			        && (window.callejeroProxy.client.req !=null)) {
		...
		var _autocompletarDireccion = function(cadena, limit, callback){
		 	window.callejeroProxy.autocompletarDireccionMunicipio(function(response){
		 	   ...
		 	   if(callback != null)
		 	    ...
		 	    if ((statusCode != 200) && errorMsg && (errorMsg != null)) {
		 	       errorMsg = OpenLayers.String.trim(errorMsg);
		 	       if (errorMsg.length() > 0) {
		 	           Mapea.Util.showErrorMessage(errorMsg);
		 	       }
		 	    }
		 	},cadena,limit, Mapea.Util.filterLocality);
		}
